...
from tropea_clustering._internal.onion_old.classes import ClusteringObject1D
from tropea_clustering._internal.onion_old.first_classes import (
    Parameters,
    StateUni,
    UniData,
)
from tropea_clustering._internal.onion_old.functions import (
    gaussian,
    max_prob_assignment,
    relabel_states,
    set_final_states,
